...
- **35 Skills**: Domain-specific knowledge activated on-demand via progressive disclosure
- **21 Agents**: Specialized AI assistants with role-based constraints (model, tools, temperature)

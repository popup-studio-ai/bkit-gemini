...
Gemini: 1. Check docs/02-design/ → Create design if missing
...
```
Gemini: 1. Compare code with design documents
...
**Generated by**: bkit-gemini
**Template Version**: 1.0.0 (Gemini CLI Edition)

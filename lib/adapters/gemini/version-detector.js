...
function getBkitFeatureFlags() {
  ...
  return {
    ...flags,
    // bkit feature gates
    canUseTeam: flags.hasTaskTracker,
    canUsePmTeam: flags.hasTaskTracker,
    canUseNativeAgents: flags.hasNativeSubagents || false,
    canUsePlanDirectory: flags.hasPlanDirectory || false,

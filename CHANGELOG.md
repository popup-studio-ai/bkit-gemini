...
## v2.0.3 (2026-04-06) — Gemini CLI v0.36.0 Stable Optimization

### Optimization
- **Agent model mismatch fix** (issue #20): Resolved agent model routing inconsistencies
- **Gemini CLI v0.36.0 stable optimization**: Performance and stability improvements for v0.36.0 runtime
- **Hook scripts refined**: after-agent, after-tool, before-tool, session-start optimized

### Changed
- **Version sync**: All 30+ files synchronized to v2.0.3 across config, runtime, lib, policies, and tests
- **PDCA status**: Updated test project status files
- **Test normalization**: tc19, tc79, tc93 test suites updated for v2.0.3 compatibility

### Strategy
- Strategy B (Enhancement) — 4th consecutive proven pattern
- Full regression pass required before merge

// tests/run-all.js - Main test runner for bkit-gemini v1.5.7
...
async function main() {
  const suites = [
    ...
    { name: 'TC-21: v0.32.x Migration', file: 'suites/tc21-v032-migration.js', priority: 'P0' },
...
function generatePDCACompletionReport(passed, failed, skipped) {
  ...
  const reportPath = path.resolve(__dirname, '../docs/04-report/features/bkit-v157-comprehensive-test.report.md');
  ...
  let report = `# bkit-gemini v1.5.7 Comprehensive Test Report
...
A total of ${total} automated test cases were executed.
